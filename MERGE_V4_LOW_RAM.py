...
MERGE_V4_LOW_RAM.py
===================
Merges V4 LoRA (Rank 512) into Frozen Genome (7B).
...
Output:
- E:/ZETAGRID/rth_lm_25b_v4_sharded/
...
V4_CHECKPOINT = os.path.join(BASE_DIR, "zeta25b_v4_expanded_FINAL.pt")
# Fallback check
if not os.path.exists(V4_CHECKPOINT) and os.name == 'nt':
     alt = os.path.join(BASE_DIR, "v4_checkpoints", "zeta25b_v4_expanded_FINAL.pt")
     if os.path.exists(alt):
         V4_CHECKPOINT = alt

OUTPUT_DIR = os.path.join(BASE_DIR, "rth_lm_25b_v4_sharded")
...
def main():
    ...
    print(f"Loading V4 LoRA: {V4_CHECKPOINT}...")
    ...
    print(f"   Use this folder with llama.cpp: ./convert-hf-to-gguf.py {OUTPUT_DIR} --outfile rth_lm_25b_v4.gguf")
