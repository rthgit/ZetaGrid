...
## 🛑 Transformers are Dinosaurs. The Future is Fractal.

**ZetaGrid 25B** is not just another LLM. It is a statement.
...
- **Green & Sustainable.** While Transformers burn forests of GPU energy, ZetaGrid runs cool and efficient. It is the democratic, on-premise alternative.

---

## 🧬 The "Soul" Architecture (TCN + Genome)
...
**ZetaGrid is Dual-Licensed:**

### 🎓 Research & Personal Use: **Free (CC BY-NC 4.0)**
You are free to use, modify, and experiment with ZetaGrid for non-commercial purposes. We encourage researchers to explore the TCN architecture.

### 💼 Commercial Use: **Paid License Required**
If you want to use ZetaGrid for commercial products, enterprise deployment, or generating revenue, you must obtain a commercial license from **RTH Italia**.
