...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_stream_TDATA", 128, hls_out, 4, "axis", "out_data", 1),
	Port_Property("out_stream_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("out_stream_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("out_stream_TKEEP", 16, hls_out, 5, "axis", "out_data", 1),
	Port_Property("out_stream_TSTRB", 16, hls_out, 6, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "pack_int4_transpose";
