; ModuleID = 'C:/Users/PC/Desktop/cpu-da/zed_hls/kernels/pack_int4_transpose/pack_int4_transpose_prj/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pack_int4_transpose_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %in_stream, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(32) %out_stream, i32 %num_elements) local_unnamed_addr #0 {
entry:
  ...
  %out_stream_copy.keep = alloca i16, align 512
  %out_stream_copy.strb = alloca i16, align 512
  %out_stream_copy.last = alloca i1, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %in_stream, i32* nonnull align 512 %in_stream_copy.data, i4* nonnull align 512 %in_stream_copy.keep, i4* nonnull align 512 %in_stream_copy.strb, i1* nonnull align 512 %in_stream_copy.last, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* nonnull %out_stream, i128* nonnull align 512 %out_stream_copy.data, i16* nonnull align 512 %out_stream_copy.keep, i16* nonnull align 512 %out_stream_copy.strb, i1* nonnull align 512 %out_stream_copy.last)
  call void @apatb_pack_int4_transpose_hw(i32* %in_stream_copy.data, i4* %in_stream_copy.keep, i4* %in_stream_copy.strb, i1* %in_stream_copy.last, i128* %out_stream_copy.data, i16* %out_stream_copy.keep, i16* %out_stream_copy.strb, i1* %out_stream_copy.last, i32 %num_elements)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %in_stream, i32* %in_stream_copy.data, i4* %in_stream_copy.keep, i4* %in_stream_copy.strb, i1* %in_stream_copy.last, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %out_stream, i128* %out_stream_copy.data, i16* %out_stream_copy.keep, i16* %out_stream_copy.strb, i1* %out_stream_copy.last)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias, i128* noalias align 512 "unpacked"="3.0" %_V_data_V1, i16* noalias align 512 "unpacked"="3.1" %_V_keep_V2, i16* noalias align 512 "unpacked"="3.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="3.3" %_V_last_V4) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.46"(i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"(i128* align 512 %_V_data_V1, i16* align 512 %_V_keep_V2, i16* align 512 %_V_strb_V3, i1* align 512 %_V_last_V4, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %1)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"(i128* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i16* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i16* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"(i128* align 512 %dst_V_data_V, i16* align 512 %dst_V_keep_V, i16* align 512 %dst_V_strb_V, i1* align 512 %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"(i128* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i16* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i16* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias, i128* noalias align 512 "unpacked"="3.0" %_V_data_V1, i16* noalias align 512 "unpacked"="3.1" %_V_keep_V2, i16* noalias align 512 "unpacked"="3.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="3.3" %_V_last_V4) unnamed_addr #4 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>.35"(%"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %1, i128* align 512 %_V_data_V1, i16* align 512 %_V_keep_V2, i16* align 512 %_V_strb_V3, i1* align 512 %_V_last_V4)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>.35"(%"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias %dst, i128* noalias align 512 "unpacked"="1.0" %src_V_data_V, i16* noalias align 512 "unpacked"="1.1" %src_V_keep_V, i16* noalias align 512 "unpacked"="1.2" %src_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %src_V_last_V) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>.38"(%"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* nonnull %dst, i128* align 512 %src_V_data_V, i16* align 512 %src_V_keep_V, i16* align 512 %src_V_strb_V, i1* align 512 %src_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>.38"(%"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nocapture, i128* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i16* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i16* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="1.3" %_V_last_V) unnamed_addr #3 {
entry:
  %1 = alloca i128
  %2 = alloca i16
  %3 = alloca i16
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.46"(i32* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i4* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i4* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.49"(i32* align 512 %dst_V_data_V, i4* align 512 %dst_V_keep_V, i4* align 512 %dst_V_strb_V, i1* align 512 %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.49"(i32* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i4* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nocapture) unnamed_addr #3 {
entry:
...
declare void @apatb_pack_int4_transpose_hw(i32*, i4*, i4*, i1*, i128*, i16*, i16*, i1*, i32)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias, i128* noalias align 512 "unpacked"="3.0" %_V_data_V1, i16* noalias align 512 "unpacked"="3.1" %_V_keep_V2, i16* noalias align 512 "unpacked"="3.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="3.3" %_V_last_V4) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %0, i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>.35"(%"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %1, i128* align 512 %_V_data_V1, i16* align 512 %_V_keep_V2, i16* align 512 %_V_strb_V3, i1* align 512 %_V_last_V4)
  ret void
...
define void @pack_int4_transpose_hw_stub_wrapper(i32*, i4*, i4*, i1*, i128*, i16*, i16*, i1*, i32) #5 {
entry:
  %9 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"
  %10 = alloca %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %10, i128* %4, i16* %5, i16* %6, i1* %7)
  call void @pack_int4_transpose_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %10, i32 %8)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %10, i128* %4, i16* %5, i16* %6, i1* %7)
  ret void
}

declare void @pack_int4_transpose_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i32)
