...
auto* sout_stream_V_data_V = createStream((hls::stream<__cosim_s16__>*)__xlx_apatb_param_out_stream_V_data_V);
  ...
  short* __xlx_out_stream_V_keep_V_input_buffer= new short[ap_apatb_out_stream_V_keep_V_cap_bc];
auto* sout_stream_V_keep_V = createStream((hls::stream<short>*)__xlx_apatb_param_out_stream_V_keep_V);
  ...
  short* __xlx_out_stream_V_strb_V_input_buffer= new short[ap_apatb_out_stream_V_strb_V_cap_bc];
auto* sout_stream_V_strb_V = createStream((hls::stream<short>*)__xlx_apatb_param_out_stream_V_strb_V);
...
auto* sout_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream_V_last_V);
  // DUT call
  pack_int4_transpose(sin_stream_V_data_V->data<int>(), sin_stream_V_keep_V->data<char>(), sin_stream_V_strb_V->data<char>(), sin_stream_V_last_V->data<char>(), sout_stream_V_data_V->data<__cosim_s16__>(), sout_stream_V_keep_V->data<short>(), sout_stream_V_strb_V->data<short>(), sout_stream_V_last_V->data<char>(), __xlx_apatb_param_num_elements);
...
sout_stream_V_keep_V->transfer((hls::stream<short>*)__xlx_apatb_param_out_stream_V_keep_V);
sout_stream_V_strb_V->transfer((hls::stream<short>*)__xlx_apatb_param_out_stream_V_strb_V);
