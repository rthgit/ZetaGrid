...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 37 \
			corename pack_int4_transpose_control_axilite \
			name pack_int4_transpose_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pack_int4_transpose_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pack_int4_transpose_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
