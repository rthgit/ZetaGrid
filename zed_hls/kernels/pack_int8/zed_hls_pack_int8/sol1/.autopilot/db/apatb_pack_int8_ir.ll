; ModuleID = 'C:/Users/PC/Desktop/cpu-da/zed_hls/kernels/pack_int8/zed_hls_pack_int8/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pack_int8_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %in_stream, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(32) %out_stream, i32 %num_elements) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_pack_int8_hw(i32* %in_stream_copy.data, i4* %in_stream_copy.keep, i4* %in_stream_copy.strb, i1* %in_stream_copy.last, i128* %out_stream_copy.data, i16* %out_stream_copy.keep, i16* %out_stream_copy.strb, i1* %out_stream_copy.last, i32 %num_elements)
...
declare void @apatb_pack_int8_hw(i32*, i4*, i4*, i1*, i128*, i16*, i16*, i1*, i32)
...
define void @pack_int8_hw_stub_wrapper(i32*, i4*, i4*, i1*, i128*, i16*, i16*, i1*, i32) #5 {
entry:
  ...
  call void @pack_int8_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* %10, i32 %8)
...
declare void @pack_int8_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<128>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i32)
