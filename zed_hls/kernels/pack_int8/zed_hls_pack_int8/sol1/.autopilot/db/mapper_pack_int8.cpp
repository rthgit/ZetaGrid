...
auto* sout_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream_V_last_V);
  // DUT call
  pack_int8(sin_stream_V_data_V->data<int>(), sin_stream_V_keep_V->data<char>(), sin_stream_V_strb_V->data<char>(), sin_stream_V_last_V->data<char>(), sout_stream_V_data_V->data<__cosim_s16__>(), sout_stream_V_keep_V->data<short>(), sout_stream_V_strb_V->data<short>(), sout_stream_V_last_V->data<char>(), __xlx_apatb_param_num_elements);
