...
print("=" * 70)
print("ZETAGRID 50B - SFT FINE-TUNING")
print("=" * 70)

BASE_DIR = "/workspace/zetagrid_50b"
MODEL_PATH = "/zetagrid_50b_expanded.npy"
SFT_DATASET = f"{BASE_DIR}/data/pretrain/KAM_SFT_MASTER.bin"
OUTPUT_MODEL = "/zetagrid_50b_generalist.npy"

# Training config
BATCH_SIZE = 4096
SEQ_LEN = 256
START_GEN = 0
TARGET_GEN = 100000  # 100K generations for generalist
...
print("\n" + "=" * 70)
print("PHASE 1: LOADING 50B MODEL")
print("=" * 70)
...
vram_used = PHYSICAL_SIZE * 2 / 1e9  # best + trial
...
while gen < TARGET_GEN:
    ...
    if gen % 10000 == 0:
        ...
        np.save("/zetagrid_50b_checkpoint.npy", genome_cpu)
        del genome_cpu
...
print(f"\n💾 Saving FINAL 50B generalist model...")
genome_cpu = cp.asnumpy(genome_best)
